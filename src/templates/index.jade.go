...
const (
	...
	index__1 = `</title></head><body><h1>Jade - template engine`
	index__2 = `</h1><div id="container" class="col">`
	index__3 = `<p class="something"><p>Jade/Pug is a terse and simple</p><p>templating language with</p><a><strong>focus</strong> on performance </a><p>and powerful features.</p></p></div></body></html>`
